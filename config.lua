...
Config.MarkerSize   = {x = 6.0, y = 6.0, z = 1.0}

Config.Money = 50 -- Kolik vám to vezme, když otevřete nabídku oblečení
Config.Debug = true
...
Config.ClothingShops = {
	...
	[15] = {
		blip = true,
		coords = vector3(-1169.88, -1580.88, 4.38),
		MarkerSize   = {x = 6.0, y = 6.0, z = 1.0}
	},
	-- VANILLA
	[16] = {
		blip = false,
		coords = vector3(105.71, -1302.98, 28.76),
		MarkerSize   = {x = 6.0, y = 6.0, z = 1.0}
	},	
	-- EMS
	--[[[17] = {
